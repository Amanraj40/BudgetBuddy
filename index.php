...
//Subtracts one day from the current date, effectively giving the date of the previous day.
...
//mysqli_fetch_assoc: This function fetches the next row of a result set as an associative array
//returns an associative array where the keys are the column names of the result set. In this case,
// it's expected to return an array with the key SUM(expense).
//['SUM(expense)'] accesses the value associated with the key SUM(expense) in the associative array returned by mysqli_fetch_assoc.
//value 0 is added to take whole value as integer
